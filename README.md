...
4. Setup IPFS
5. Update chatGPT OPENAI_API_Key
...
5. Update OPENAI_API_KEY variable in `./ai-service/configs/.env.gateway`:

   ```shell
   OPENAI_API_KEY=...
   ```

7. Build and launch with Docker. Please note that this build is meant to be used in production and will not contain any
   debug information. From the project's root folder:
